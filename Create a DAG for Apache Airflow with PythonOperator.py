#  will create a DAG, which will define a pipeline of tasks, such as extract, transform, load, 
# and check with PythonOperator.
# Create a DAG file, my_first_dag.py, which will run daily. The my_first_dag.py file defines tasks execute_extract, execute_transform, execute_load,
# and execute_check to call the respective Python functions.
